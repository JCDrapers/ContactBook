...
import javax.swing.WindowConstants as Closer
...
frame = swing.frame(title:"James' Contact Book", pack:true, visible:true, defaultCloseOperation:Closer.HIDE_ON_CLOSE) {
    panel(id:'mainPanel'){
...
//                      textField( id: "description$num", text:panelID, columns: 30 )
                        button( id: "buttonpanel$num", text:"More", actionPerformed:{
                            ...
                            frame2 = swing.frame(title:"$Contact's Information", pack:true, visible:true, defaultCloseOperation:Closer.DO_NOTHING_ON_CLOSE) {
